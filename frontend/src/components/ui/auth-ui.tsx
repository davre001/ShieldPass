...
const defaultSignUpContent = {
    ...
    quote: {
        text: "Create your passkey. Zero-Knowledge awaits.",
        author: "ShieldPass Protocol"
    }
};
    ...
    <div className="w-full min-h-screen md:grid md:grid-cols-2">
      ...
      >
        ...
        <div className="relative z-10 flex h-full flex-col items-center justify-end p-2 pb-12">
            <blockquote className="space-y-2 text-center text-foreground max-w-lg">
              ...
              <cite className="block text-sm font-light text-muted-foreground not-italic mt-4">
