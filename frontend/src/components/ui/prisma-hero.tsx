          ...
          <div className="grid grid-cols-12 items-end gap-4">
            ...
            <div className="col-span-12 flex flex-col gap-5 pb-6 lg:col-span-4 lg:pb-10">
              ...
              <motion.p
                ...
                className="text-xs text-white/70 sm:text-sm md:text-base text-white"
              ...
              <motion.button
                ...
                className="group inline-flex items-center justify-center gap-2 self-start rounded-full bg-white py-2 pl-6 pr-2 text-sm font-medium text-black transition-all hover:gap-3 sm:text-base"
              >
                Join the lab
                <span className="flex h-9 w-9 items-center justify-center rounded-full bg-black transition-transform group-hover:scale-110 sm:h-10 sm:w-10">
                   <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" style={{ color: "#E1E0CC" }}>
